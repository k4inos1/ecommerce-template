...
router.post('/validate', protect, async (req: AuthRequest, res: Response, _next: NextFunction) => {
  try {
...
router.get('/', protect, adminOnly, async (_req: AuthRequest, res: Response, _next: NextFunction) => {
  try {
...
router.post('/', protect, adminOnly, async (req: AuthRequest, res: Response, _next: NextFunction) => {
  try {
...
router.patch('/:id', protect, adminOnly, async (req: AuthRequest, res: Response, _next: NextFunction) => {
  try {
...
router.delete('/:id', protect, adminOnly, async (req: AuthRequest, res: Response, _next: NextFunction) => {
  try {
